...
<div class="sidenav-overlay"></div>
    ...
    <footer class="footer footer-static footer-light navbar-shadow">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
            <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2024 <a class="text-bold-800 grey darken-2" href="https://1.envato.market/modern_admin" target="_blank">EventifyU</a>
        </span>
    ...
    <script src="../../../app-assets/js/scripts/extensions/fullcalendar-events.js"></script>
    <!-- END: Page JS-->
