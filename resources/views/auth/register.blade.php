...
<head>
    ...
    <title>Register with EventifyU</title>
                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0 pb-0">
                                    ...
                                    <div class="card-body">
                                    @if ($errors->all())
                                            <div class="bg-danger text-light mb-2 p-1">
                                                <span class="" style="color:#fff">{{ $errors->first() }}</span>
                                            </div>
                                    @endif
                                        ...
                                        @csrf
                                            <fieldset class="form-group position-relative has-icon-left">
                                                ...
                                                <!-- <span class="text-danger small">Please Enter Full Name</span> -->
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" id="user-text" name="student_id" placeholder="Student Id *" required>
                                                <div class="form-control-position">
                                                    <i class="la la-key"></i>
                                                </div>
                                            </fieldset>
                                    ...
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>New to EventifyU?</span></p>
                                    <div class="card-body">
